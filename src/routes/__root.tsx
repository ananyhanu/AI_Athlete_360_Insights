...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "AI Athlete 360 — AI Powered Battery Fitness Assessment" },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/8d7b1e9c-e32f-4a3c-ba2e-60ad688e40de",
      },
      {
        name: "twitter:image",
        content:
